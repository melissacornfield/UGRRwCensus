...
lyr_UGRRMappingProjectDataSetNov42024_3.set('fieldLabels', {'Title': 'inline label - visible with data', 'Name(s) related to site': 'no label', 'freedom seeker name related to site': 'no label', 'short description': 'inline label - visible with data', 'More information': 'no label', 'type (stationary)': 'inline label - visible with data', 'Routes': 'no label', 'Town/ City': 'inline label - visible with data', 'present day county': 'no label', 'state': 'no label', 'date of settlement in Illinois': 'no label', 'Time Active': 'no label', 'Date Range of Travel Through Illinois': 'no label', 'source type': 'no label', 'Reliability': 'no label', 'lat': 'no label', 'lon': 'no label', 'geoAddress': 'no label', 'Nearest Current Address': 'no label', 'Access': 'no label', 'Start Year': 'no label', 'End Year': 'no label', 'entered by': 'no label', 'entry date': 'no label', 'link to data entry template': 'no label', });
